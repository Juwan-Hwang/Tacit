...
mod tests {
    ...
    fn dao_device_identity_roundtrip() {
        ...
        let rec = dao::DeviceIdentityRecord {
            signing_key: zeroize::Zeroizing::new([0x01; 32]),
            static_private: zeroize::Zeroizing::new([0x02; 32]),
        ...
        assert_eq!(loaded2.signing_key, rec2.signing_key, "新身份应已覆盖旧身份");
        assert_eq!(loaded2.static_public, rec2.static_public, "static_public 应更新");
    }
