...
├──────────────────────────────────────────────────┤
│                  tacit-session                   │  Engine↔transport wiring, codec, LoopbackTransport
├──────────────────────────────────────────────────┤
...
| `tacit-session` | Engine↔transport wiring: drive_outbound, handle_transport_event, codec, LoopbackTransport |
